      ...
      if ((str.find_first_not_of(" \t\r\n") != string::npos) && (str[0] != '#')) {
        ...
        if (cmd == "light") {
          if (numused == numLights) { // No more Lights
            ...
            if (validinput) {
              ...
              lightposn[0 + offset] = values[0];
              lightposn[1 + offset] = values[1];
              lightposn[2 + offset] = values[2];
              lightposn[3 + offset] = values[3];
              lightcolor[4 + offset] = values[4];
              lightcolor[5 + offset] = values[5];
              lightcolor[6 + offset] = values[6];
              lightransf[7 + offset] = values[7];
        ...
        // Also look at demo.txt to get a sense of why things are done this way.
          ...
          if (validinput) {
            ...
            mat4 t = Transform::translate((float)values[0],
                                          (float)values[1],
                                          (float)values[2]);
          ...
          if (validinput) {
            ...
            // You might want to use helper functions on top of file.
            // Also keep in mind what order your matrix is!
            mat4 s = Transform::scale((float)values[0],
                                      (float)values[1],
                                      (float)values[2]);
          ...
          if (validinput) {
            ...
            float theta = (float)values[3];
            vec3 axis = vec3((float)values[0],
                             (float)values[1],
                             (float)values[2]);
